...
from src.core.video_loader import VideoLoader, VideoLoadError, UnsupportedFormatError
...
def sample_metadata() -> VideoMetadata:
    return VideoMetadata(
        path="/test/video.mp4",
        width=1920, height=1080, fps=24.0, duration=10.0,
        frame_count=240, codec_name="h264", codec_long_name="H.264 / AVC",
        pixel_format="yuv420p", bit_rate=5000000, file_size=6250000,
        has_audio=True, audio_codec="aac", audio_sample_rate=48000,
        audio_channels=2, container_format="mp4",
    )
